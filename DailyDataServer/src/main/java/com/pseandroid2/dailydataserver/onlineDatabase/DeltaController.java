...
public class DeltaController {
    ...
    public boolean saveDelta(@PathVariable long projectId, @RequestAttribute String user,
    ...
    public boolean provideOldData(@PathVariable long projectId, @RequestAttribute String user,
