...
public class DeltaController {
     ...
     */
    @GetMapping("/get/{id}")
    public List<Delta> getDelta(@PathVariable("id") long projectId, @RequestAttribute String user, @RequestHeader String token) {
        /*
    ...
    public boolean provideOldData(@PathVariable("id") long projectId, @RequestAttribute String user,
                                  @RequestBody ProvideOldDataParameter params, @RequestHeader String token) {
        /*
        - aufräumen
        - platz checken:
         - Deltas hinzufügen,
     ...
     */
    @GetMapping("/time")
    public long getRemoveTime(@RequestHeader String token) {
        /*
         * Zeit zurückgeben
         */
        return 0;
