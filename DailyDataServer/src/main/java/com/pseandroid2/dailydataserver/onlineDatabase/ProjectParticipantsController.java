...
public class ProjectParticipantsController {
     ...
     *
     * @param name of the participant, who wants to know who the admin is. (generated by the server)
     * @param projectId the id from which the admin is recommended. (provided by the client)
     * @param param the data, for authenticate the user. {@link RequestParameter} specifies this parameter.
     * @return
     */
    @GetMapping("/{id}/admin")
    public String getAdmin(@RequestAttribute String name, @PathVariable("id") long projectId, @RequestBody RequestParameter param){
        return "";
    }
}
