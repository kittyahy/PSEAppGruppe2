...
public class ProjectParticipantsController {
    ...
    public boolean addUser(@RequestAttribute String user, @PathVariable("id") long projectId, @RequestHeader String token) {
     ...
     * @param params    all information, which are necessary to remove a user from a project.
     * @return true, if the user is removed, false if it was not possible.
     */
    @DeleteMapping("/removeUser/{id}")
    public boolean removeUser(@RequestAttribute String user, @PathVariable("id") long projectId, @RequestBody RemoveUserParameter params, @RequestHeader String token) {
    ...
    public long addProject(@RequestAttribute String user, @RequestHeader String token) {
    ...
    public List<String> getParticipants(@RequestAttribute String user, @PathVariable("id") long projectId, @RequestHeader String token) {
     ...
     */
    @GetMapping("/{id}/admin")
    public String getAdmin(@RequestAttribute String user, @PathVariable("id") long projectId, @RequestHeader String token) {
